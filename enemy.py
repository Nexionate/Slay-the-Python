enemies_easy = (
    {"name": "mugger", "current HP": 1, "max HP": 36, "current block": 0, "attack pattern": False, "attack": [{"damage": 7, "block": 0}, {"damage": 11, "block": 0}, {"damage": 5, "block": 10}, {"damage": 0, "block": 10}]},
    {"name": "slime", "current HP": 1, "max HP": 21, "current block": 0, "attack pattern": False, "attack": [{"damage": 4, "block": 0}, {"damage": 6, "block": 6}, {"damage": 5, "block": 0}]},
    {"name": "fat gremlin", "current HP": 1, "max HP": 32, "current block": 15, "attack pattern": False, "attack": [{"damage": 6, "block": 0}, {"damage": 0, "block": 10}, {"damage": 4, "block": 13}]},
