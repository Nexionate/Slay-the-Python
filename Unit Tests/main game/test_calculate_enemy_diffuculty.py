...
class Test(TestCase):
    @patch('random.choice',
           side_effect=[{"name": "mugger", "current HP": 6, "max HP": 36, "current block": 0, "attack pattern": False,
                         "attack": [{"damage": 7, "block": 0}, {"damage": 11, "block": 0}, {"damage": 5, "block": 7},
                                    {"damage": 0, "block": 8}]}])
    def test_calculate_enemy_difficulty_reward_normal(self, _):
        event = "fight"
    ...
    def test_calculate_enemy_difficulty_reward_elite(self, _):
        event = "elite"
    ...
    def test_calculate_enemy_difficulty_reward_boss(self, _):
        event = "boss"
        boss_attacks = [{"damage": 8, "block": 0},
                        {"damage": 6, "block": 0, "debuff": 2},
                        {"damage": 12, "block": 0},
